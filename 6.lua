...
local kyTab = window:Tab("『墨水游戏』", "7733774602")
local kySection = kyTab:section("『墨水』", true)
kySection:Button("墨水游戏", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/Xingtaiduan/Script/refs/heads/main/Games/墨水游戏.lua"))()
end)

local krTab = window:Tab("『动物捉迷藏』", "7733774602")
local krSection = krTab:section("『捉迷藏』", true)
krSection:Button("动物捉迷藏", function()
...
local kiTab = window:Tab("『黑暗欺骗』", "7733774602")
local kiSection = kiTab:section("『黑暗』", true)
kiSection:Button("黑暗欺骗", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/Guo61/his/refs/heads/main/Hunted.lua"))()
end)

local kwTab = window:Tab("『元素大亨』", "7733774602")
local kwSection = kwTab:section("『元素大亨』", true)
kwSection:Button("元素大亨", function()
...
local kuTab = window:Tab("『自然灾害黑洞』", "7733774602")
local kuSection = kuTab:section("『自然灾害黑洞』", true)
kuSection:Button("黑洞", function()
